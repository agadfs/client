...
export default function CharacterMovingDown(body) {
...
<div style={{
        ...
        <div style={{
          position: 'relative', width: '3px', height: '5px',
          backgroundColor: 'black', top: '-2px', left: '9px'
        }}>

        </div>
        <div style={{
          position: 'relative', width: '7px', height: '2px',
          backgroundColor: 'black', top: '1px', left: '4px'
        }}>
